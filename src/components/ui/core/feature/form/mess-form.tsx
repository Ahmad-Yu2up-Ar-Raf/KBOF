...
import { CreateMessFormReturn } from '@/hooks/form/use-mess-form'

interface MessFormProps {
  // CreateMessFormReturn works for both create & update forms
  // because they have identical field structures (structural typing)
