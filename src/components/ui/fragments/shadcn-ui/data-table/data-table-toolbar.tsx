...
import { DataTableSliderFilter } from '@/components/ui/fragments/shadcn-ui/data-table/data-table-slider-filter'
import { DataTableViewOptions } from '@/components/ui/fragments/shadcn-ui/data-table/data-table-view-options'
        ...
        case 'text':
          return (
            <Input
              ...
              className="h-8  relative w-full col-span-2 sm:w-40 lg:w-65"
            />
          )
