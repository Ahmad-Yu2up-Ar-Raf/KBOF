  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="pointer-events-none absolute inset-x-0 top-6 mx-auto h-48 w-[70%] rounded-full bg-accent-foreground/5 blur-3xl dark:bg-white/5"
          aria-hidden="true"
        />
        <div
          className="pointer-events-none absolute inset-x-0 bottom-0 mx-auto h-40 w-[76%] rounded-full bg-accent-foreground/10 blur-3xl dark:bg-accent-foreground/30"
          aria-hidden="true"
        />
            ...
            {items.map((item, i) => {
              ...
              return (
                <motion.div
                  key={item.id}
                  className={cn(
                    'absolute bottom-0 rounded-2xl border-4 border-accent-foreground/10 dark:border-white/10 overflow-hidden shadow-xl',
...
function DefaultFanCard({ item }: { item: CardStackItem; active: boolean }) {
  return (
    <div className="relative h-full w-full">
      ...
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-accent-foreground/60 via-transparent to-transparent" />
