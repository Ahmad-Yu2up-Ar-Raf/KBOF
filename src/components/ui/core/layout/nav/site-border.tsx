...
function SiteBorder() {
  return (
    <div className=" fixed inset-0 z-9999999 md:z-999999999    [&_svg]:fill-primary [&_svg]:size-17 [&_svg]:md:size-22 pointer-events-none  flex flex-col justify-between  h-full w-full p-2">
