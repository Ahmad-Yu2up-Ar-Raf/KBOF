...
import {
  ...
  FacetedList,
  FacetedTrigger,
} from '@/components/ui/fragments/shadcn-ui/faceted'
...
import {
  ...
  SortableItemHandle,
  SortableOverlay,
} from '@/components/ui/fragments/shadcn-ui/sortable'
    ...
    >
      ...
      <SortableOverlay>
        <div className="flex items-center gap-2">
          <div className="h-8 min-w-[72px] rounded-xl bg-primary/10" />
          <div className="h-8 w-32 rounded-xl bg-primary/10" />
          <div className="h-8 w-32 rounded-xl bg-primary/10" />
          <div className="h-8 min-w-36 flex-1 rounded-xl bg-primary/10" />
          <div className="size-8 shrink-0 rounded-xl bg-primary/10" />
          <div className="size-8 shrink-0 rounded-xl bg-primary/10" />
        </div>
      </SortableOverlay>
    </Sortable>
