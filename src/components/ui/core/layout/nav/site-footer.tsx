...
export default function SiteFooter({ className, ...props }: StickyFooterProps) {
  ...
  if (isActive)
    return (
      <footer
        className={cn(
          'relative bg-muted py-20 min-h-svh content-center z-40 w-full',
          className,
        )}
        ...
        <div className="fixed z-50 bottom-0 h-full w-full">
          ...
          >
            ...
            <div className="w-full h-fit flex items-center justify-center  ">
              <h1 className="text-center lg:h-80 relative text-[24lvw] lg:text-[16em] font-bold bg-clip-text tracking-tighter   bg-linear-to-b to-background text-transparent from-yellow-950/50 select-none">
                Suasana.
              </h1>
            </div>
          </div>
